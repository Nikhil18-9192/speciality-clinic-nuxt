      ...
      <div class="container">
        <div class="left">
          ...
          <div class="image-container">
            ...
            <div class="image">
              <img src="/beautiful-young-woman.jpg" alt="" />
            </div>
          </div>
        </div>
        <div class="right">
    ...
    .container {
      ...
      .left {
        ...
        ul {
          ...
          padding-left: 20px;
          :nth-child(odd) {
            list-style-image: url('/list-black.svg');
          }
          :nth-child(even) {
            list-style-image: url('/list-blue.svg');
          }
          li {
            font-weight: 400;
            font-size: 16px;
